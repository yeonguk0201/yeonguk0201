...
## 👋 About Me
안녕하세요! 프론트엔드 개발자를 꿈꾸는 주니어 개발자입니다!
단순히 서비스를 만드는 메이커가 아닌, 서비스에 대해 깊게 생각하고 좋은 서비스를 만들기 위해 고민하는 것을 좋아하며 유저의 입장에서 어떻게 하면 쓰기 좋을지, 사용하기 편한 서비스를 제공할 지 고민합니다.
특히 프론트 개발자로서 UI/UX 고민도 함께 해야한다고 생각해 유저가 편한 UI를 지향합니다.
...
**Currently Studying**
<div align="left">
  <img src="https://img.shields.io/badge/Three.js-black?style=flat&logo=threedotjs"/>
</div>
